var TableData = function() {
	...
	var runDataTable_example2 = function() {
		...
		function editRow(oTable, nRow) {
			...
			jqTds[3].innerHTML = '<a class="save-row" href="">Salvar</a>';
			jqTds[4].innerHTML = '<a class="cancel-row" href="">Cancelar</a>';
		...
		function saveRow(oTable, nRow) {
			...
			oTable.fnUpdate('<a class="edit-row" href="">Editar</a>', nRow, 3, false);
			oTable.fnUpdate('<a class="delete-row" href="">Apagar</a>', nRow, 4, false);
			oTable.fnDraw();
			newRow = false;
