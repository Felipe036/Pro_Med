...
if(isset($_POST['submit']))
{
    $con=new conexao();
    $con->conect();
    $sql = mysqli_query($con->bd, "SELECT password FROM  users where password='" . ($_POST['cpass']) . "' && emailuser='" . $_SESSION['login'] . "'");
...
<html lang="pt-br">
	<head>
		<title>Paciente  | Mudar Senha</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Paciente | Mudar Senha</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Paciente</span>
