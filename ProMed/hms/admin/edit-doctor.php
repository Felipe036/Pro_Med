...
<html lang="pt-br">
	<head>
		<title>Admin | Editar Detalhes Médico</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Editar Detalhes Médico</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Editar Detalhes Médico</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
							<div class="row">
								<div class="col-md-12">
                                    ...
                                    $con=new conexaoadmin();
                                    $con->conect();
                                    $sql=mysqli_query($con->bd,"select * from doctors where id='$did'");
